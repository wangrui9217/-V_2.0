				...
				<el-form label-position='left' :model='companyOperationInfo' ref='companyOperationInfo' label-width="165px">
					...
					<el-row>
						<el-col :span="16">
							...
							<el-input v-model='companyOperationInfo.businessDescription' type='textarea' :rows='4' :disabled="isDisabled"></el-input>
						</el-form-item>
						</el-col>
					</el-row>
				</el-form>
					...
					<!--<el-row :gutter="30">-->
						...
						<!--<el-col :span="8">-->
							<!--<el-form-item label="采购结算方式">-->
								<!--<el-select v-model="companyPurchaseInfoRequest.purchaseSettlementMode" placeholder="请选择" :disabled="isDisabled">-->
									<!--<el-option-->
					...
					<!--<el-row>-->
						<!--<el-col :span="16">-->
							<!--<el-form-item label="其他信息补充">-->
								<!--<el-input v-model='companyPurchaseInfoRequest.purchaseOtherInfo' type='textarea' :rows='4' :disabled="isDisabled"></el-input>-->
							<!--</el-form-item>-->
						<!--</el-col>-->
					<!--</el-row>-->
				<!--</el-form>-->
					...
					<!--<el-row :gutter="30">-->
						<!--<el-col :span="8">-->
							<!--<el-form-item label="销售结算方式">-->
								<!--<el-select v-model="companySaleRequest.saleSettlementMode" placeholder="请选择" :disabled="isDisabled">-->
									<!--<el-option-->
					...
					<!--<el-row>-->
						<!--<el-col :span="16">-->
							<!--<el-form-item label="主要下游客户">-->
								<!--<el-input v-model='companySaleRequest.mainDownstreamCustomer' type='textarea' :rows='4' :disabled="isDisabled"></el-input>-->
							<!--</el-form-item>-->
						<!--</el-col>-->
					<!--</el-row>-->
				<!--</el-form>-->

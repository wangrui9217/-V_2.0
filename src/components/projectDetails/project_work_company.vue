  ...
  <div :class="{'g-listpage__style' : !isDisabled}">
      ...
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane
          ...
          <div>
            <div>
              <p class="common-title" style="line-height:20px;padding-bottom: 20px;">企业基本信息</p>
              <div class="common-group">
                <el-form
                  ...
                  <el-row>
                    ...
                    <el-col :span="8">
                      ...
                      <el-input :disabled="isDisabled"
                        v-model="companyform.companyUpdateRequest.registerAddressDetail"
                        placeholder="详细地址"/>
                    </el-form-item>
                    </el-col>
                  </el-row>
                  <el-row>
                    <el-col :span="8">
                      <el-form-item
                      prop="companyUpdateRequest.censusAddressList"
                      :rules="$rules.requiredInputDate"
                      label="实际经营地址">
                      <el-cascader :disabled="isDisabled"
                        :props="{value: 'id',label: 'name'}"
                        :options="$dict.getDictData('Area')"
                    ...
                    <el-col :span="8">
                      ...
                      <el-input :disabled="isDisabled"
                        v-model="companyform.companyUpdateRequest.actualOperatingAddressDetail	"
                        placeholder="详细地址"
                        width="300px"/>
                    </el-form-item>
                    </el-col>
                  ...
                  <el-row>
                    <el-col :span="16">
                      <el-form-item label="经营范围" >
                        <el-input :disabled="isDisabled"
                          :rows="2"
                          v-model="companyform.companyUpdateRequest.businessScope"
                          type="textarea"
                          style="width: 88%"
                          placeholder="请输入内容" />
                      </el-form-item>
                      <!-- <div class="grid-content bg-purple-light">
                        <p style="padding-bottom: 10px">经营范围 </p> -->
                  ...
                  <el-row>
                    <el-col :span="16">
                      ...
                      <!-- <div class="grid-content bg-purple-light">
                        <p style="padding-bottom: 10px">其他情况说明 </p> -->
            ...
            <div style="padding-bottom:20px;">
              ...
              <el-table
                ...
                <el-table-column
                  label="股东名称"
                  align="center"
                  :rules="$rules.requiredInputValue">
                  <template slot-scope="scope">
                    <el-input  v-model="scope.row.name" :disabled="isDisabled"/>
                  </template>
                </el-table-column>
                <el-table-column
                  label="持股比率(%)"
                  align="center">
                  <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.holdingRatio" :disabled="isDisabled"/>
                  </template>
                </el-table-column>
                <el-table-column
                  label="备注"
                  align="center">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.remark" :disabled="isDisabled"/>
                  </template>
                </el-table-column>
                <el-table-column v-if="!isDisabled"
                  ...
                  <template slot-scope="scope">
                    <div class="actions">
                      <el-button
                        type="text"
                        @click.native.prevent="deleteRow(scope.$index,companyform.companyShareholderInfoList)">
                        删除
                      </el-button>
                    </div>
                  </template>
              ...
              <el-button v-if="!isDisabled"
                class="common-button"
                @click="addRow(companyform.companyShareholderInfoList)"><i
        ...
        <el-tab-pane
          label="企业经营信息完善"
          name="second">
          <corppManagementInfo :isDisabled="isDisabled" :isCheck="isCheck" :hasSubmit="hasSubmit" ref="companyOperationInfo"/>
        </el-tab-pane>
        ...
        <el-tab-pane
          ...
          <el-row style="margin-top: 200px" v-if="!isDisabled && !isCheck">
            <el-button
              type="primary"
...
import corppManagementInfo from "./corpp_management_info";
            ...
            this.$refs.companyform.validate(flag => {
              if (flag) {
                this.$refs.companyOperationInfo.formRef.validate(flag => {
                  if (flag) {
                    const companyOperationInfo = this.$refs
    ...
    company(companyId) {
      companyController
        ...
        .then(res => {
          ...
          this.$store.commit('SET_COMPANY_INFO',this.companyUpdateRequest)
          if (

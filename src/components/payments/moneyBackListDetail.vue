    ...
    <div class="common-container">
      <div>
        ...
        <el-table
          ...
          <el-table-column
            type="selection"
            :selectable="row => row.planState == 0"
            width="55">
          </el-table-column>
          <el-table-column
            prop="terms"
        ...
        <el-form :model="ruleForm2" status-icon ref="ruleForm2" label-width="140px" class="demo-ruleForm">
          <el-form-item label="还款金额:" prop="repaymentAmount"  :rules='$rules.requiredInputValue'>
            <el-input  v-model="ruleForm2.repaymentAmount" type="number"></el-input>
          </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      approveCheck () {
        ...
        this.ruleForm2.terms = this.terms
    ...
    computed: {
      terms () {
        const selectData = [...this.selectVal, ...this.selectVal2]
        return selectData.map(val => {
          return {
            terms: val.terms,
            type: val.type
          }

          ...
          <div>
            ...
            <el-table
              ...
              <el-table-column label="操作" width="80">
                <template slot-scope="scope">
                  <el-button type="text" @click="loanApply(scope.row, 'approve')" v-if="scope.row.state == 0">处理</el-button>
                  <el-button type="text" @click="loanApply(scope.row)" v-else>查看</el-button>
                </template>
              </el-table-column>
            </el-table>
            <el-pagination
